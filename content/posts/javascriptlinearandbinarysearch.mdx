...
tags:
  ...
  - javascript
---
> ***An algorithm is a finite sequence of well-defined instructions, typically used to solve a class of specific problems or to perform a computation.f***[](https://en.m.wikipedia.org/wiki/Algorithm)
>
> ![]()
>
